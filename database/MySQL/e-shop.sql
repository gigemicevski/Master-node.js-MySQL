...
ALTER TABLE products DROP Order_Quantity;
...
SELECT products.Product_id,products.Name,products.Unit_price,order_items.Order_id,order_items.Product_id,order_items.Quantity
FROM products 
...
SELECT Order_id,order_items.Product_id,Quantity,products.Name,products.Unit_price 
FROM `e-shop`.order_items 
JOIN products 
